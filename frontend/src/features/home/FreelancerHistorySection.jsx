  ...
  return (
    <section className=" py-8 px-4 rounded-2xl shadow-md mt-4 md:mt-10">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Right: Title */}
        <div className="flex items-center px-2 gap-3 mt-2 md:mb-4">
        ...
        {/* Left: Cards */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 gap-y-6 mt-4 md:mt-0 w-full md:w-1/2 max-w-4xl">
